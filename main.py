...
app = FastAPI(title='Backstract Generated APIs - coll-ac00aa86ca294213b2cc4bcba6b3d2b9', debug=False,
              docs_url='/vigorous-hellman-1833fbaa532d11f0a6d082abc893da1b67/docs',
              openapi_url='/vigorous-hellman-1833fbaa532d11f0a6d082abc893da1b67/openapi.json')
...
app.include_router(
    router,
    prefix='/vigorous-hellman-1833fbaa532d11f0a6d082abc893da1b67/api',
    tags=['APIs v1']
)
